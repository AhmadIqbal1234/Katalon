...
WebUI.setText(findTestObject('Object Repository/Admin/Page_OrangeHRM/input'), 'A8DCo 4Ys 010Z')

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Admin/Page_OrangeHRM/div_A8DCo 4Ys 010Z'))
